...
// Query to fetch trainees with today's evaluation date
$sql = 'SELECT * FROM trainee WHERE supervisorId=:supId AND nextevaluationDate = :currentDate';
$statement = $connection->prepare($sql);
$statement->execute([':supId' => $supId, ':currentDate' => $currentDate]);
...
<head>
    ...
    <title>🕛Today's check-in list</title>
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
    ...
    <div class="offcanvas-body">
      <div>
        <form action="search.php" method="get">
            <div class="form-floating mb-3">
                ...
                <button class="btn btn-outline-success" style="width: 100%;"><i class="fas fa-magnifying-glass"></i> Search</button>
              </div>
      ...
      <aside class="menu">
        ...
        <ul class="menu-list">
          <li ><a href="index.php">⏹ List Of Trainees</a></li>
          <li><a class="is-active">🕛Today's check-in list</a></li>
        </ul>
        <p class="menu-label">
          Administration
        </p>
