...
$sql = 'SELECT * FROM trainee WHERE supervisorId=:supId AND name LIKE :res';
$statement = $connection->prepare($sql);
$statement->execute([':supId'=> $supId,':res'=> '%'.$res.'%']);
...
<!-- Table Section -->
<div class="box">
  <?php if(!$trainees || $_GET["q"]==""){echo "<div class='alert alert-danger'>No Results</div>";}?>
